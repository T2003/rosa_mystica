...
<section class="slider-hero">
    ...
    <div class="hero-slider">
        <div class="item">
            <div class="work">
                <div class="img img2 d-flex align-items-center js-fullheight" style="background-image: url(images/homu2.jpg);">
        ...
        <div class="item">
            <div class="work">
                <div class="img d-flex align-items-center justify-content-center js-fullheight" style="background-image: url(images/hom.jpg);">
                    <div class="container-xl">
                        <div class="row d-flex justify-content-center">
                            <div class="col-md-7">
                                <div class="text text-center mt-lg-5">
    ...
    <div class="container">
        <div class="row ">
            <div class="col-md-6 d-none d-md-block text-center">
                <br><br><br>
                <img src="images/seour.png" width="100%" marin-left="3cm" alt="">
            </div>
            <div class="col-md-6 heading-section" data-aos="fade-up" data-aos-duration="1000" style="padding-top: 1rem;padding-bottom: 1rem;">
                <span class="subheading">Headmistress Message</span>
                <h2 class="mb-4">“Learning starts at birth and
                    ends at death”</h2>
                ...
                <a href="https://youtu.be/JAfgCPIBplg/ROSA MYSTICA TV">
...
<section class="ftco-section bg-light">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-1">
                <div style="width: 5rem;height: 5rem; border: 8px rgb(155 200 76)  solid;padding-top:1rem;text-align: center;border-radius: 50%;">
                    1
                </div>
            </div>
            <div class="col-lg-11">
    ...
    <div class="container-xl-fluid">
        ...
        <div class="row g-0">
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000">
                <a href="images/skl411.jpg" class="gallery-wrap img d-flex align-items-end justify-content-center glightbox" style="background-image: url(images/skl411.jpg);">
                    <div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-search"></span></div>
                    <div class="text">
                        <h2 class="mb-0">School Bus</h2>
                    </div>
                </a>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">
                <a href="images/a.jpg" class="gallery-wrap img d-flex align-items-end justify-content-center glightbox" style="background-image: url(images/a.jpg);">
                    <div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-search"></span></div>
                    <div class="text">
                        <h2 class="mb-0">Finger Sign</h2>
                    </div>
                </a>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="300" data-aos-duration="1000">
                <a href="images/5.jpg" class="gallery-wrap img d-flex align-items-end justify-content-center glightbox" style="background-image: url(images/5.jpg);">
                    <div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-search"></span></div>
                    <div class="text">
                        <h2 class="mb-0">Culture</h2>
                    </div>
                </a>
            </div>
            <div class="col-md-3" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                <a href="images/b.jpg" class="gallery-wrap img d-flex align-items-end justify-content-center glightbox" style="background-image: url(images/b.jpg);">
                    <div class="icon d-flex align-items-center justify-content-center"><span class="fa fa-search"></span></div>
                    <div class="text">
                ...
                <div class="col-md-6 col-lg-3" data-aos="flip-right" data-aos-delay="100" data-aos-duration="1000">
                    <div class="staff">
                        ...
                        <div class="text text-center">
                            ...
                            <p style="font-size: 14px;font-weight: 600;"><?php echo $dean['email'] ?></p>
                            <!-- <div class="faded">
                ...
                <div class="carousel-testimony">
                        ...
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                ...
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image: url(images/kaze.jpg)"></div>
                                    <div class="ps-3"><br>
                                        <p class="name">kaze BAYINGANA Auxane</p>
                                        <span class="position">Nursery Student</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4">Our school is family because we study how to work with others that help us to reach our future.</p>
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image: url(images/keza.jpg)"></div>

                                    <div class="ps-3"><br>
                                        <p class="name">AGATESI KEZA Pamella</p>
                                        <span class="position">Primary Student</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4">Here they teach us how to live with disability student and others in slogan called "Disability is not inability" .</p>
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image: url(images/ange.jpg)"></div>
                                    <div class="ps-3">
                                        <p class="name">Ashimwe Ange Irisine</p>
                                        <span class="position">Primary Student </span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4">Our school give us freedom and fell free with others and teach us to love our country and to believe in God.</p>
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image: url(images/prince.jpg)"></div>
                                    <div class="ps-3">
                                        <p class="name">MUGABE Prince</p>
                                        <span class="position">Secondary Student with Disability</span><br><br>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="testimony-wrap">
                            ...
                            <div class="text">
                                <p class="mb-4">Here discpline is our partion, reason why we study hard,work hard and pray hard those help to performe at high level.</p>
                                <div class="d-flex align-items-center">
                                    <div class="user-img" style="background-image: url(images/romeo.jpg)"></div>
                                    <div class="ps-3">
                                        <p class="name">ISINGIZWE Romeo Bruce</p>
                                        <span class="position"> Secondary Student</span>
                                    </div>
                                </div>
                            </div>
                        </div>
